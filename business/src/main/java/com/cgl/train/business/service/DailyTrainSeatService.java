...
import com.cgl.train.business.domain.DailyTrainSeat;
import com.cgl.train.business.domain.DailyTrainSeatExample;
import com.cgl.train.business.domain.TrainSeat;
import com.cgl.train.business.domain.TrainStation;
import com.cgl.train.business.mapper.DailyTrainSeatMapper;
...
public class DailyTrainSeatService {
    ...
    public void deleteByTrainCodeAndCarriageIndex(String trainCode,Integer index){
        DailyTrainSeatExample dailyTrainSeatExample=new DailyTrainSeatExample();
        dailyTrainSeatExample.createCriteria().andTrainCodeEqualTo(trainCode).andCarriageIndexEqualTo(index);
        dailyTrainSeatMapper.deleteByExample(dailyTrainSeatExample);
    }
    @Transactional
