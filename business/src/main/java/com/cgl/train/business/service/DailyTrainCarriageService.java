...
import com.cgl.train.business.domain.DailyTrainCarriage;
import com.cgl.train.business.domain.DailyTrainCarriageExample;
import com.cgl.train.business.domain.TrainCarriage;
import com.cgl.train.business.enums.SeatColEnum;
import com.cgl.train.business.mapper.DailyTrainCarriageMapper;
import com.cgl.train.business.req.DailyTrainCarriageQueryReq;
import com.cgl.train.business.req.DailyTrainCarriageSaveReq;
import com.cgl.train.business.resp.DailyTrainCarriageQueryResp;
...
public class DailyTrainCarriageService {
    ...
    public void deleteByTrainCodeAndCarriageIndex(String trainCode, Integer index){
        DailyTrainCarriageExample dailyTrainCarriageExample=new DailyTrainCarriageExample();
        dailyTrainCarriageExample.createCriteria().andTrainCodeEqualTo(trainCode).andIndexEqualTo(index);
        dailyTrainCarriageMapper.deleteByExample(dailyTrainCarriageExample);
    }
    @Transactional
